        ...
        {popupVisible && <div className="popup-message">{popupMessage}</div>}
            ...
            <div className="main-content">
                <div className="hero-image">
                    <img src="https://cdn.1stautoworks.sg/car-grooming-with-washing-waxing-and-polishing-services.jpg" alt="Hero" />
                </div>
                <div className="content">
                    <p>At WheelBro, our car body polishing service is designed to restore and enhance the shine of your vehicle’s exterior. We start with a thorough wash to remove any surface dirt and grime, ensuring a clean canvas for the polishing process.
                        </p>
                </div>
                <div className="highlighted-content">
                    <p>"Shine bright with WheelBro’s car polish—your ride’s glow-up awaits!"</p>
                </div>
                <div className="additional-content">
                    <img src="https://www.shutterstock.com/image-photo/car-detailing-polishing-concept-hands-600nw-1703968147.jpg" alt="Additional 1" />
                    <p>Our skilled technicians then apply a high-quality polishing compound that gently removes scratches, oxidation, and imperfections from the paintwork. Using advanced techniques and tools, we meticulously polish every inch of your car’s body, enhancing its gloss and depth. <br /><br />
                    The result is a showroom-quality finish that makes your vehicle look brand new. We also apply a protective layer to shield the paint from environmental elements and extend the shine. </p>
